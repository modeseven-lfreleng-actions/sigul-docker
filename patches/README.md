...
This directory contains patches that add comprehensive debugging output to the Sigul v1.4 source code to help diagnose double-TLS connection and authentication issues.

## Purpose

These patches are applied during the Docker image build process to instrument the Sigul client, bridge, and server components with additional logging. This helps diagnose:
...
5. Patches directory is cleaned up after installation
...
The install script will detect the absence of patches and proceed normally.
...
3. Include descriptive error messages, not just values
